...
int main() {
  std::vector<double> a = {0, 2, -8, -6, 9};         // нижняя
  std::vector<double> b = {-6, 10, 18, 17, 14};      // главная
  std::vector<double> c = {6, -7, 9, -6, 0};         // верхняя
  std::vector<double> d = {30, -31, 108, -114, 124}; // значения
